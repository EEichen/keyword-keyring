            ...
            <div>
                ...
                <div className='hover-hint'>
                    ...
                    <input
                        ...
                        />
                    {showHints && <span className='req-hint hint'>sets the minimum uppercase letters in the password</span>}
                </div>
            </div>
            <div>
                ...
                <div className='hover-hint'>
                    <input
                        ...
                        />
                    {showHints && <span className='req-hint hint'>sets the minimum numbers in the password</span>}
                </div>
            </div>
            <div>
                ...
                <div className='hover-hint'>
                    <input
                        ...
                        />
                    {showHints && <span className='req-hint hint'>sets the minimum symbols in the password</span>}
                </div>
            </div>
        </div>
    )
